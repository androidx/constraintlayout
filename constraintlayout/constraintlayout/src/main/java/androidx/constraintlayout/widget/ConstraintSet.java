...
//                        }
     ...
     * @return
     */
    private static String toFile(ConstraintLayout constraintLayout, String fileName) {
     ...
     */
    @SuppressLint("LogConditional")
    private static void log(String tag, ConstraintLayout constraintLayout) {
        DumpCL c = new DumpCL();
        Log.v(tag, c.constraintLayoutToJson(constraintLayout));
    }

    private static void log(Writer writer, ConstraintLayout layout, int flags) throws IOException {
        writer.append(asString(layout));
    }
    ...
    private static class WriteJsonEngine {
        ...
        private void writeConstraint(String my,
            ...
            mWriter.write(", ");
            mWriter.write("'" + other + "'");
            if (margin != 0 || goneMargin != Layout.UNSET_GONE_MARGIN) {
                mWriter.write(", " + margin);
                if (goneMargin != Layout.UNSET_GONE_MARGIN) {
