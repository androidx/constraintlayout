...
class GuidelineReference extends WidgetRun {
    ...
    private void addDependency(androidx.constraintlayout.solver.widgets.analyzer.DependencyNode node) {
    ...
    public void update(Dependency dependency) {
        ...
        androidx.constraintlayout.solver.widgets.analyzer.DependencyNode startTarget = start.targets.get(0);
