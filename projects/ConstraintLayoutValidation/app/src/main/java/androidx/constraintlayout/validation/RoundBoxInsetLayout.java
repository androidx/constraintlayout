...
/**
 * Copy of wear's BoxInsetLayout forcing a round screen to capture bug b/136738279
 *
 ...
 */
@UiThread
public class RoundBoxInsetLayout extends ViewGroup {
     ...
     */
    public RoundBoxInsetLayout(@NonNull Context context) {
        this(context, null);
    }
    /**
     ...
     */
    public RoundBoxInsetLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
     ...
     *                 defaults.
     */
    public RoundBoxInsetLayout(@NonNull Context context, @Nullable AttributeSet attrs, @StyleRes int
            defStyle) {
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new RoundBoxInsetLayout.LayoutParams(getContext(), attrs);
    }
    @RequiresApi(api = Build.VERSION_CODES.KITKAT_WATCH)
    @Override
    protected void onAttachedToWindow() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            ...
            // mIsRound = getWidth() == getHeight(); // force to round
            if (!mIsRound) {
                ViewGroup parent = (ViewGroup) getParent();
                mIsRound = parent.getWidth() == parent.getHeight();
            }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != GONE) {
                LayoutParams lp = (RoundBoxInsetLayout.LayoutParams) child.getLayoutParams();
                int marginLeft = 0;
                int marginRight = 0;
                int marginTop = 0;
                int marginBottom = 0;
