...
public class SaveVideo {
    ...
    public SaveVideo(Done callback) {
        mCallback = callback;
    }
...
//                .subscribe();
    ...
    public static void sampleEncode () {
        SaveVideo bitmapToVideoEncoder = new SaveVideo(  file -> {
            Log.v(TAG, "Done " + file.getName());
        });
