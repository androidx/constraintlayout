...
public class SceneDisplayListTest3  extends JPanel {
    ...
    String simpleList = "DrawComponentFrame,0,0,1000,1000,1,1000,1000\n" +
                        ...
                        "DrawConnection,2,450x490x100x20,2,450x490x100x20,3,0,true,0,0,false,0.5,0,0,0\n" +
                        "DrawConnection,2,450x490x100x20,3,0x0x1000x1000,3,1,false,0,0,false,0.5,0,0,0\n" +
                        "UNClip\n";

  DisplayList disp;
  SceneDisplayListTest3() {
  ...
  public static void main(String[] args) {
    ...
    frame.setContentPane(new SceneDisplayListTest3());
