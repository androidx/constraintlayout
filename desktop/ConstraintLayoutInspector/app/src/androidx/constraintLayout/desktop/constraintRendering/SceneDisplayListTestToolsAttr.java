...
public class SceneDisplayListTestToolsAttr   extends JPanel {


    String simpleList = "DrawComponentFrame,0,0,1000,1000,1,1000,1000\n" +
                        "Clip,0,0,1000,1000\n" +
                        "DrawComponentBackground,450,490,100,20,1\n" +
                        "DrawTextRegion,450,490,100,20,0,16,false,false,5,5,28,1.0,\"text\"\n" +
                        ...
                        "DrawComponentBackground,450,490,100,20,1\n" +
                        "DrawTextRegion,450,490,100,20,0,16,false,false,5,5,28,1.0,\"tools\"\n" +
                        "DrawComponentFrame,450,490,100,20,1,20,20\n" +
                        "DrawConnection,6,450x490x100x20,0,450x490x100x20,0,0,true,0,0,false,0.5,0,0,0\n" +
                        "DrawConnection,6,450x490x100x20,1,450x490x100x20,1,0,true,0,0,false,0.5,0,0,0\n" +
                        "DrawConnection,5,450x506x100x0,5,450x506x100x0,5,0,false,0,0,false,0.0,0,0,0\n" +
    ...
    public static void main(String[] args) {
        ...
        frame.setContentPane(new SceneDisplayListTestToolsAttr());
