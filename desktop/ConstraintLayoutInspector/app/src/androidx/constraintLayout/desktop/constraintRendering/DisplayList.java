...
import androidx.constraintLayout.desktop.constraintRendering.draw.DrawComponentBackground;
import androidx.constraintLayout.desktop.constraintRendering.draw.DrawComponentFrame;
import androidx.constraintLayout.desktop.constraintRendering.draw.DrawTextRegion;
...
public class DisplayList {
  ...
  public void paint(Graphics2D g2, SceneContext sceneContext) {
    if (!myUnClipStack.isEmpty()) {
      System.err.println("There are still clippings in the clip stack.");
      myUnClipStack.clear();
    }
