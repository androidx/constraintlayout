...
public class CalendarRecycler2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("MotionLayout in Recycler View");
    ...
    static class CustomAdapter extends RecyclerView.Adapter<CustomViewHolder> {
        ...
        public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
            ...
            View view = inflater.inflate(R.layout.calendar_motion, viewGroup, false);
