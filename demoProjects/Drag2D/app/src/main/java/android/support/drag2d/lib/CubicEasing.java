...
public class CubicEasing implements MaterialVelocity.Easing {
   ...
   // public static final CubicEasing ANTICIPATE = new CubicEasing(ANTICIPATE_COEFFICIENTS);
    ...
    public static final MaterialVelocity.Easing EASE_OUT_ELASTIC = new MaterialVelocity.Easing() {
    ...
    public static final MaterialVelocity.Easing EASE_OUT_BOUNCE = new MaterialVelocity.Easing() {
        double n1 = 7.5625;
        double d1 = 2.75;
        @Override
        public double get(double t) {
